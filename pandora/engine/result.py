...
evidence already on hand names the action. There are six rules, they are a list
because a seventh is expected, and every one of them is a function of facts that
...
named that exists here and was not shipped, a write-back and what it found.
...
RULES = (oom, timed_out, drifted, missing_report, written_back, gitignored)
