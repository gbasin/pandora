...
COPY ["apps/borrower-web/package.json", "./apps/borrower-web/package.json"]
COPY ["apps/borrower/package.json", "./apps/borrower/package.json"]
...
COPY ["legacy/apps/ike-api/package.json", "./legacy/apps/ike-api/package.json"]
COPY ["legacy/apps/ike-web/package.json", "./legacy/apps/ike-web/package.json"]
...
COPY ["legacy/packages/ike-ui/package.json", "./legacy/packages/ike-ui/package.json"]
