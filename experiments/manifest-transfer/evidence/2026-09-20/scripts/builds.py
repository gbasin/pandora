...
for index in range(3):
    ...
    result=subprocess.run(['python3','-B',str(p/'warm_probe.py'),'--host','ubuntu@40.160.93.34','--repo','/Users/garybasin/Code/eichler/.worktrees/pandora-compiled-build','--output',str(output),'--workflow','docker','--docker-request',spec],stdout=subprocess.PIPE,stderr=subprocess.STDOUT,text=True)
