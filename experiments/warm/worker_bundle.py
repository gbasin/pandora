...
NAMES = ['worker_bundle.py', 'evidence.py', 'suite_parent.py', 'suite_parent_evidence.py', 'suite_parent_cleanup.py', 'suite.py', 'suite_evidence.py', 'suite.mjs', 'workflow_options.py', 'admission.py', 'snapshot.py', 'worker.py', 'deadline_stop.py', 'dependencies.py', 'retention.py', 'source_cache.py',
